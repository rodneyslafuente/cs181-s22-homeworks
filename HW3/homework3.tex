...
$$\implies \frac{n\bar{x}}{\sigma^2} - \frac{n\mu_{MLE}}{\sigma^2} - \frac{\mu_{MLE}}{\tau^2} = 0$$
$$\implies \tau^2n\bar{x} - \tau^2n\mu_{MLE} - \sigma^2\mu_{MLE} = 0$$
$$\implies (\tau^2n + \sigma^2)\mu_{MLE} = \tau^2n\bar{x}$$
$$\implies \mu_{MLE} = \frac{\tau^2n\bar{x}}{\tau^2n + \sigma^2}$$
